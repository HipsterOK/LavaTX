...
static void runPwrOffCharging(void)
{
  ...
  uint16_t keysState[5];
  GPIO_TypeDef *keysPort[5] = {GPIOA, GPIOB, GPIOC, GPIOD, GPIOE};
  uint16_t keysPin[5] = {KEYS_GPIOA_PINS, KEYS_GPIOB_PINS, KEYS_GPIOC_PINS, KEYS_GPIOD_PINS, KEYS_GPIOE_PINS};
#endif
