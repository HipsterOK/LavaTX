...
#define ROTARY_ENCODER_POSITION() ( ((ENC_GPIO->IDR >> 8) & 0x01) | ((ENC_GPIO->IDR >> 9) & 0x02) )
...
// ======================
// SWITCH A (3-position) PE4 / PE5
// ======================
#define STORAGE_SWITCH_A
#define HARDWARE_SWITCH_A
#define SWITCHES_GPIO_REG_A_H GPIOE->IDR
#define SWITCHES_GPIO_PIN_A_H GPIO_Pin_5 // PE4
#define SWITCHES_GPIO_REG_A_L GPIOE->IDR
#define SWITCHES_GPIO_PIN_A_L GPIO_Pin_4// PE5

#define STORAGE_SWITCH_B
#define HARDWARE_SWITCH_B
#define SWITCHES_GPIO_REG_B GPIOE->IDR
#define SWITCHES_GPIO_PIN_B GPIO_Pin_0 // PE0

#define STORAGE_SWITCH_C
#define HARDWARE_SWITCH_C
#define SWITCHES_GPIO_REG_C_H GPIOE->IDR
#define SWITCHES_GPIO_PIN_C_H GPIO_Pin_2 // PE.03
#define SWITCHES_GPIO_REG_C_L GPIOE->IDR
#define SWITCHES_GPIO_PIN_C_L GPIO_Pin_3 // PE.02

#define STORAGE_SWITCH_D
#define HARDWARE_SWITCH_D
#define SWITCHES_GPIO_REG_D GPIOE->IDR
#define SWITCHES_GPIO_PIN_D GPIO_Pin_1 // PE.01
...
#define KEYS_GPIOE_PINS (SWITCHES_GPIO_PIN_A_H | SWITCHES_GPIO_PIN_A_L | SWITCHES_GPIO_PIN_C_H | SWITCHES_GPIO_PIN_C_L | SWITCHES_GPIO_PIN_D | SWITCHES_GPIO_PIN_B)
...
#define TELEMETRY_DIR_GPIO_PIN   0
#define TELEMETRY_DIR_OUTPUT()   do {} while(0)
#define TELEMETRY_DIR_INPUT()    do {} while(0)

// RX polarity pin — оставить как есть
...
// CRSF для TBS Tango использует AUX_SERIAL (UART3)
#define CRSF_RCC_AHB1Periph AUX_SERIAL_RCC_AHB1Periph
#define CRSF_RCC_APB1Periph AUX_SERIAL_RCC_APB1Periph
#define CRSF_GPIO AUX_SERIAL_GPIO
#define CRSF_GPIO_PIN_TX AUX_SERIAL_GPIO_PIN_TX
#define CRSF_GPIO_PIN_RX AUX_SERIAL_GPIO_PIN_RX
#define CRSF_GPIO_PinSource_TX AUX_SERIAL_GPIO_PinSource_TX
#define CRSF_GPIO_PinSource_RX AUX_SERIAL_GPIO_PinSource_RX
#define CRSF_GPIO_AF AUX_SERIAL_GPIO_AF
#define CRSF_USART AUX_SERIAL_USART
#define CRSF_USART_IRQHandler AUX_SERIAL_USART_IRQHandler
#define CRSF_USART_IRQn AUX_SERIAL_USART_IRQn
#define CRSF_DMA_Stream_RX AUX_SERIAL_DMA_Stream_RX
#define CRSF_DMA_Channel_RX AUX_SERIAL_DMA_Channel_RX
...
// Audio
#define AUDIO_RCC_AHB1Periph (RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_DMA1)
...
#define AUDIO_MUTE_GPIO_PIN GPIO_Pin_7 // PD.07 (исправлено согласно таблице)
#elif defined(RADIO_MAMBO)
